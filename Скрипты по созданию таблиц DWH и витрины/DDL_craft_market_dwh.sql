...
CREATE TABLE dwh.d_products (
	...
	product_source int8 NOT NULL,
	product_craftsmans int8 NOT NULL,
...
COMMENT ON COLUMN dwh.d_products.product_source IS 'номер схемы откуда взяли продукт';
COMMENT ON COLUMN dwh.d_products.product_craftsmans IS 'айди владельца продукта';
